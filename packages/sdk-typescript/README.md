...
#### Agent-Cli Installation Required

Version 0.1.0 requires [Agent-Cli](https://github.com/MuscleGear5/agent-cli) **>= 0.4.0** to be installed separately and accessible in your PATH.

```bash
# Install Agent-Cli globally
npm install -g agent-cli@^0.4.0
```

**Note**: From version **0.1.1** onwards, the CLI is bundled with the SDK, so no separate Agent-Cli installation is needed.
