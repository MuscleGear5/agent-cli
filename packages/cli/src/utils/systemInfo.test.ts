...
import { IdeClient } from '@musclegear555/agent-cli-core';
...
describe('systemInfo', () => {
  ...
  describe('getExtendedSystemInfo', () => {
    it('should include memory usage and base URL', async () => {
      ...
      const { AuthType } = await import('@musclegear555/agent-cli-core');
