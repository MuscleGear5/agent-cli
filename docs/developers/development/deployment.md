...
- **Directly from the Registry:**
  ...
  docker run --rm -it ghcr.io/qwenlm/agent-cli:0.0.11
  ```
...
npx https://github.com/MuscleGear5/agent-cli
```
...
- `@musclegear555/agent-cli-core`: The backend, handling logic and tool execution.
- `@musclegear555/agent-cli`: The user-facing frontend.
...
- **NPM publication:** For publishing to the NPM registry, the TypeScript source code in `@musclegear555/agent-cli-core` and `@musclegear555/agent-cli` is transpiled into standard JavaScript using the TypeScript Compiler (`tsc`). The resulting `dist/` directory is what gets published in the NPM package. This is a standard approach for TypeScript libraries.
