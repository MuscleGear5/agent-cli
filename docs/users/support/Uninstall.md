...
If you installed the CLI globally (e.g. `npm install -g @musclegear555/agent-cli`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @musclegear555/agent-cli
```
