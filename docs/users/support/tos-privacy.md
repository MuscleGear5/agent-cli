...
1. **Agent-Cli Auth** - Log in with your agent-cli account
...
| :-------------------- | :---------------- | :---------------------------------------------------------------------------- | :----------------------------------------------------- |
| Agent-Cli Auth        | Qwen AI           | [Qwen Terms of Service](https://agent-cli/termsservice)                       | [Qwen Privacy Policy](https://agent-cli/privacypolicy) |
...
## 1. If you are using Agent-Cli Auth Authentication

When you authenticate using your agent-cli account, these Terms of Service and Privacy Notice documents apply:

- **Terms of Service:** Your use is governed by the [Qwen Terms of Service](https://agent-cli/termsservice).
- **Privacy Notice:** The collection and use of your data is described in the [Qwen Privacy Policy](https://agent-cli/privacypolicy).
...
> [!important]
>
> When using OpenAI-compatible API authentication, you are subject to the terms and privacy policies of your chosen API provider, not Agent-Cli's terms. Please review your provider's documentation for specific details about data usage, retention, and privacy practices.
...
Agent-Cli may collect anonymous usage statistics and [telemetry](../../developers/development/telemetry) data to improve the user experience and product quality. This data collection is optional and can be controlled through configuration settings.
...
- **Agent-Cli Auth:** Usage statistics are governed by Qwen's privacy policy. You can opt-out through Agent-Cli's configuration settings.
...
- **Agent-Cli Auth**: Data usage is governed by [Qwen's Privacy Policy](https://agent-cli/privacy). Please refer to their policy for specific details about data collection and model training practices.
...
You can switch between Agent-Cli Auth and OpenAI-compatible API authentication at any time:
