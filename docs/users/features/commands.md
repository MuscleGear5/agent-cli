...
This document details all commands supported by Agent-Cli, helping you efficiently manage sessions, customize the interface, and control its behavior.

Agent-Cli commands are triggered through specific prefixes and fall into three categories:

| Prefix Type                | Function Description                                | Typical Use Case                                                 |
| -------------------------- | --------------------------------------------------- | ---------------------------------------------------------------- |
| Slash Commands (`/`)       | Meta-level control of Agent-Cli itself              | Managing sessions, modifying settings, getting help              |
...
Slash commands are used to manage Agent-Cli sessions, interface, and basic behavior.
...
| `/bug`          | Submit issue about Agent-Cli                    | `/bug Button click unresponsive`                 |
...
Exclamation commands allow you to execute system commands directly within Agent-Cli.
...
| Global Commands  | `~/.agent-cli/commands/`                        | Available in all projects              | Low      | Personal frequently used commands, cross-project use |
| Project Commands | `<project root directory>/.agent-cli/commands/` | Project-specific, version-controllable | High     | Team sharing, project-specific commands              |
...
| --------------------------------- | ----------------- | --------------------- |
| `~/.agent-cli/commands/test.toml` | `/test`           | `/test Parameter`     |
...
| ----------------------------- | ------------------------------------------------ |
| 1. Create directory structure | `mkdir -p ~/.agent-cli/commands/refactor`        |
| 2. Create command file        | `touch ~/.agent-cli/commands/refactor/pure.toml` |
| 3. Edit command content       | Refer to the complete code below.                |
| 4. Test command               | `@file.js` → `/refactor:pure`                    |

```# ~/.agent-cli/commands/refactor/pure.toml
